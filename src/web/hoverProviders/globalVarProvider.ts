        ...
        switch (tag) {
            case "Name":
                return vscode.l10n.t(
                    " \
The Name tag contains the proper name of the package. \
Names must not include whitespace and may include a hyphen ‘-‘ (unlike version and release tags). \
Names should not include any numeric operators (‘<’, ‘>’,’=’) \
as future versions of rpm may need to reserve characters other than ‘-‘."
                );
            case "Version":
                return vscode.l10n.t(
                    " \
Version of the packaged content, typically software.\n\n \
The version string consists of alphanumeric characters, which can optionally be segmented with the separators \
., _ and +, plus ~ and ^ (see below).\n\n \
